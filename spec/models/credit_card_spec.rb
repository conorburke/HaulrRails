...
#     it 'has a number' do
#       expect(creditcard).to have_attributes(card_number: "1234-1234-1234-1234")
#     end
...
#         it { should allow_value('1234-1234-1234-1234').for(:card_number) }
#         it { should_not allow_value('1234-1234-abcd-abcd').for(:card_number) }
#       end
